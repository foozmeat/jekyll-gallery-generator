...
This fork has been optimized for use with [Bootstrap 3](http://getbootstrap.com) and the [Blue Imp](https://github.com/blueimp/Gallery) gallery system.
...
This plugin is quite minimalist. It generates galleries with no pagination and no sub-galleries. [See my gallery](http://jmoore.me/photos/) for an example of what it looks like.
...
Add an optional description.md to your photo directories and the contents will be rendered at the top of the gallery
